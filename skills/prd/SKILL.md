...
2. 基于第二步的功能分析，逐节填写模板内容（**文档信息模块的「功能名称」「所属模块」「作者」暂不填写**）
3. 所有内容必须来自代码分析，不得填写无法确认的内容
4. 无法从代码中获取的信息（如背景、目标），在对应位置留空并标注 `<!-- 待填写 -->`，不得编造
